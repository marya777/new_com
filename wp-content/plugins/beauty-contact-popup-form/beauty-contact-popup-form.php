	  ...
	  $html .= '<div id="TagPopup_FormContainerBody">';
		$html .= '<form action="#" name="TagPopup_Form" id="TagPopup_Form">';
		  ...
		  $html .= '<div id="TagPopup_FormLabel_Page">';
			$html .= '<input name="TagPopup_name" class="TagPopup_TextForm" type="text" id="TagPopup_name" Placeholder="Ваше Имя" maxlength="120">';
		  $html .= '</div>';
		  $html .= '<div id="TagPopup_FormLabel_Page">';
			$html .= '<input name="TagPopup_mail" class="TagPopup_TextForm" type="text" id="TagPopup_mail"  Placeholder="Введите Email" maxlength="120">';
		  $html .= '</div>';
		  $html .= '<div id="TagPopup_FormLabel_Page">';
			$html .= '<textarea name="TagPopup_message" class="TagPopup_TextArea" rows="3" id="TagPopup_message"  Placeholder="Введите сообщение"></textarea>';
		  $html .= '</div>';
		   $html .= '<input type="hidden" id="TagCorrectsum" name="TagCorrectsum" value="'.$tagsum.'"/>';
		  $html .= '<div id="TagPopup_FormLabel_Page" class="TagPopup_Human" > '.__('Подтвердите, что Вы человек :', 'tag-popup').' '.$tagnumber1.' + '.$tagnumber2.' = ';
		   $html .= '</div>';
			$html .= '<input name="TagPopup_captcha" class="TagPopup_TextForm" type="text" id="TagPopup_captcha"  Placeholder="Введите сумму : " maxlength="120">';
		  $html .= '<div id="TagPopup_FormLabel_Page">';
			$html .= '<input type="button" name="button" class="TagPopup_Button" value="Отправить" onClick="javascript:TagPopup_Submit(this.parentNode,'.$siteurl.');">';
		  $html .= '</div>';
		$html .= '</form>';
	  $html .= '</div>';
	$html .= '</div>';
